<?php
    ...
    $sql = $conn->query("SELECT adminID FROM admin WHERE ademail='$email' AND adusername='$un'");
    ...
    if ($sql->num_rows > 0) {
        ...
        $mail->Body = "<h1>You've lost your Password</h1> 
                            ...
                            <a href='localhost/ABSolutions/a-resetPassword.php?email=$email&token=$token'>
